...
# STEP 7: TRAINING AND TESTING OUR DATASET

#installing and loading relevent packages
...
# forming a classifying obj (in form of losgistic regression model) to model training set
# here, we are also firring our variables into our clasifying object
train.fit <- glm(Sold ~ price + age , data = train_set, family = binomial)



# STEP 9: CREATING OUR CONFUSION MATRIX AND ANALYZING PERFORMANCE

# predicting values of dependent variables based on classifying object that we formed
